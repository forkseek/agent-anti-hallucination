...
description: "Reduces AI agent hallucination via a two-line-of-defense mechanism: (1) pre-task questioning to fill context gaps based on task complexity (L1/L2/L3), and (2) anchor-marker self-check with [CTX-LOCK]/[CTX-VERIFIED] wrapping every reply so context loss becomes visible. Use for every task by default to prevent fabricated requirements, file names, and context drift."
license: MIT
---
